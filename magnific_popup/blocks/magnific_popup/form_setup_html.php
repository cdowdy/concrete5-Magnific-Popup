...
<ul id="ccm-magnific-tabs" class="ccm-dialog-tabs tabs">
  ...
  <li><a href="javascript:void(0)" id="ccm-magnific-options"><?php echo t('Magnific Options'); ?></a></li>
</ul>

<div class="clearfix">
  <div id="ccm-magnific-options-tab" class="ui-helper-hidden">
  <!--
...
-->
  <div id="galleryImages" class="ccm-block-field-group">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <?php echo $form->select('fsID', $fileSets, $fsID, array('class' => 'span3')); ?>
...
<!-- Tab Setup -->
<script type="text/javascript">
  var ccm_fpActiveTab = "ccm-magnific-type"; 
